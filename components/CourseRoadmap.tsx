...
const CourseRoadmap: React.FC = () => {
  ...
  const COURSE_DATA = [
  {
    ...
    color: 'text-teal-500',
    classes: [
      { name: '劍橋英檢．KET養成班', desc: '針對劍橋英檢 KET 級數，強化聽說讀寫全方位實力', age: '小五 ~ 小六', time: '週三/六', objectives: '熟悉劍橋英檢 KET 考試題型，強化聽說讀寫綜合能力，順利取得國際認證。', target: '計畫報考 KET 英檢 or 希望檢視英語學習成效的學生。', features: ['仿真模考實戰演練', '口試技巧個別指導', '聽力解題策略分析', '閱讀寫作重點強化'], roadmap: ['檢定觀念建立', '分項能力強化', '模考衝刺與檢討'] },
